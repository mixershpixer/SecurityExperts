...
namespace SE.DAL.Migrations
{
    ...
    [Migration("20200415094335_SE.DAL.SEContext")]
    partial class SEDALSEContext
    {
            ...
            modelBuilder.Entity("SE.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("903a743e-9427-4a05-a762-ff92a91fdb1d"),
                        ...
                        new
                        {
                            Id = new Guid("c1f3b7d8-1094-4dbe-a3bb-b33ecc0300cb"),
